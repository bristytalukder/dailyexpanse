...
<div class="col-lg-11 float-left p-3 3 mx-5 ">
            <div class="card justify-content-center">
                ...
                <div class="card-body card-block">
                    <form action="inAdd" method="POST" enctype="multipart1/form-data" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="inamount" class=" form-control-label">Enter Amount:</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="inamount" name="in_amount" placeholder="enter your amount" class="form-control"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="indate" class=" form-control-label">Date :</label></div> 
                            <div class="col-12 col-md-9"><input type="date" id="indate" name="date" placeholder="12/12/1/2022" class="form-control"></div>
                        </div>
                         <div class="row form-group">
                            ...
                            <select name="in_category" id="select" class="form-control">
                                    <option value="0">Please select a category</option>
                                        <?php foreach ($inCategory as $row) :?>
                                            <option value="<?= $row['inc_id']?>"><?= $row['inc_name']?></option>
                                        <?php endforeach?>
                            </select>
                        </div>
